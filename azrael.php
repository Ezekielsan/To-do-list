...
<div class="main-section">  
       ...
       <?php
           $ezekiel = $conn->query("SELECT * FROM ezekiel ORDER BY id DESC") ;
       ?>
       <div class="show-todo-section">
        <?php if ($ezekiel->rowCount() <= 0) {?>
        <div class="todo-item">
           <div class="empty">
            ...
            <?php while( $todo = $ezekiel->fetch(PDO::FETCH_ASSOC)) {?>
                <div class="todo-item">
                    <span id="<?php echo $todo['id']; ?>"
                    class="remove-to-do">x</span>
                    <?php if($todo ['checked']) {?>
                        <input type="checkbox"
                               class="check-box"data-todo-id="<?php echo $todo['id'];?>"
